insert into movie (name, genre, runtime, description) values ('Star Wars IV - A New Hope', 'SCI_FI', '2ó5p', 'description1');
insert into movie (name, genre, runtime, description) values ('Star Wars V - The Empire Strikes Back', 'SCI_FI', '2ó4p', '');
insert into movie (name, genre, runtime, description) values ('Star Wars VI - Return of the Jedi', 'SCI_FI', '2ó11p', '');
insert into movie (name, genre, runtime, description) values ('Star Wars VII - The Force Awakens', 'SCI_FI', '2ó16p', '');
