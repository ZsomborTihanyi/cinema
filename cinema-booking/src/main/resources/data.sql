insert into movie (movie_name, genre, runtime, description) values ('Star Wars IV - A New Hope', 'sci-fi', '2ó5p', 'description1');
insert into movie (movie_name, genre, runtime, description) values ('Star Wars V - The Empire Strikes Back', 'sci-fi', '2ó4p', '');
insert into movie (movie_name, genre, runtime, description) values ('Star Wars VI - Return of the Jedi', 'sci-fi', '2ó11p', '');
insert into movie (movie_name, genre, runtime, description) values ('Star Wars VII - The Force Awakens', 'sci-fi', '2ó16p', '');
